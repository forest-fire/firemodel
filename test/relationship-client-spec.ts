...
describe("Relationship > ", () => {
  ...
  it(
    "using addToRelationship() to relationship with inverse (M:1)",
    async () => {
      const person = await Record.add(FancyPerson, {
        name: "Bob",
        age: 23,
      ...
      expect(paths).toEqual(expect.arrayContaining(["car-offset/cars/car12345/lastUpdated"]));
      expect(paths).toEqual(expect.arrayContaining(["car-offset/cars/car12345/owner"]));
  ...
  it(
    "using addToRelationship() to relationship with inverse (M:M)",
    async () => {
      const bob = await Record.add(FancyPerson, {
        name: "Bob",
        age: 23,
  ...
  it(
    "using addToRelationship() to add multiple relationships with inverse (M:M)",
    async () => {
  ...
  it(
    "using setRelationship() on an hasOne prop sets relationship",
    async () => {
  ...
  it(
    "using clearRelationship() on an hasOne prop sets relationship",
    async () => {
      const bob = await Record.add(FancyPerson, {
        name: "Bob",
        age: 23,
