...
describe("Record static utils", () => {
  ...
  it(
    "Record.compositeKey() with 1 path deep works when data is complete",
    async () => {
  ...
  it(
    "Record.compositeKey() with 2 path deep works when data is complete",
    async () => {
  ...
  it(
    "Record.compositeKeyRef() 1 path deep works when data is complete",
    async () => {
  ...
  it(
    "Record.compositeKeyRef() 2 path deep works when data is complete",
    async () => {
