import { pathJoin as pathJoin$1, wait, dotNotation } from 'common-types';
...
export { AuditLog, DexieDb, DexieList, DexieRecord, FireModel, FmEvents, List, Mock, Model, OneWay, Record, RelationshipCardinality, RelationshipPolicy, VeuxWrapper, Watch, belongsTo, constrain, constrainedProperty, createCompositeKey, defaultValue, desc, encrypt, hasMany, hasOne, index, isConstructable, length, listRegisteredModels, max, min, mock, model, modelConstructorLookup, modelNameLookup, modelRegister, modelRegistryLookup, ownedBy, pathJoin, property, pushKey, uniqueIndex };
