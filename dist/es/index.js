...
export { FireModel, FmEvents, List, Mock, NamedFakes, OneWay, Record, RelationshipCardinality, RelationshipPolicy, Watch, belongsTo, constrain, constrainedProperty, defaultValue, desc, encrypt, getDbIndexes, hasMany, hasOne, index, indexesForModel, length, max, min, mock, model, ownedBy, property, propertyDecorator, propertyReflector, pushKey, uniqueIndex };
