import { IFmRelationshipDirectionality, IFnToModelConstructor, IModelConstructor } from "../types";
 ...
 */
fkClass: IFnToModelConstructor | IModelConstructor | string, inverse?: string | [string, IFmRelationshipDirectionality]): (modelKlass: import("../types").IModel, key: string) => void;
