...
import { IListOptions, IModel, IPrimaryKey } from "../../@types/index";
import { WatchBase } from "./WatchBase";
import { epochWithMilliseconds } from "common-types";
export declare class WatchList<T extends IModel> extends WatchBase<T> {
     ...
     * @param query
     */
    fromQuery(inputQuery: ISerializedQuery<T>): WatchList<T>;
    /**
     * **all**
     *
