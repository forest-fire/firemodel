...
exports.FiremodelMockApi = void 0;
...
function FiremodelMockApi(db, modelConstructor) {
    ...
    const MockApi = {
        ...
        async generate(count, exceptions = {}) {
            ...
            const props = private_1.mockProperties(db, config, exceptions);
            const relns = private_1.addRelationships(db, config, exceptions);
...
exports.FiremodelMockApi = FiremodelMockApi;
//# sourceMappingURL=firebase-mock-api.js.map