...
import { IModelConstructor, IPrimaryKey, IDexiePriorVersion, DexieList, DexieRecord, Model } from "@/private";
/**
...
export declare class DexieDb {
     ...
     */
    static modelConversion<T extends Model>(...modelConstructors: Array<IModelConstructor<T>>): IDictionary<string>;
    /**
