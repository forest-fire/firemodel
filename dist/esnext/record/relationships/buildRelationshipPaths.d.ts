 ...
 */
export declare function buildRelationshipPaths<T>(rec: Record<T>, property: keyof T, fkRef: IFkReference<T>, options?: IFmBuildRelationshipOptions): IFmPathValuePair[];
