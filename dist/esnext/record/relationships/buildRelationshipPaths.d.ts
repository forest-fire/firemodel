 ...
 */
export declare function buildRelationshipPaths<T>(rec: Record<T>, property: Extract<keyof T, string>, fkRef: IFkReference, options?: IFmBuildRelationshipOptions): IFmPathValuePair[];
