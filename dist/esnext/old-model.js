...
export class OldModel extends FireModel {
    //#endregion
    ...
    static create(schema, options = {}) {
        ...
        const model = new OldModel(schema, db, logger);
        return model;
    }
    ...
    async push(newRecord, auditInfo = {}) {
        ...
        const response = await this.crud("push", now, slashNotation(this.dbPath, id), newRecord, auditInfo);
        return response;
    }
...
OldModel.auditBase = "logging/audit_logs";
//# sourceMappingURL=old-model.js.map