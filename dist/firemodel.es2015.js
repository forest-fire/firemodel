...
class Record extends FireModel {
    ...
    async update(props) {
        ...
        if (Object.keys(props).some((key$$1) => {
            const root = key$$1.split(".")[0];
...
function __decorate(decorators, target, key$$1, desc) {
...
class List$$1 extends FireModel {
    ...
    filterWhere(prop, value) {
        ...
        const list = new List$$1(this._modelConstructor);
...
export { property, pushKey, constrainedProperty, constrain, min, max, length, desc, mock, hasMany, ownedBy, inverse, model, Model, RelationshipPolicy, RelationshipCardinality, Record, List$$1 as List };
