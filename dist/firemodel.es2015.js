            ...
            if (!config.cardinality ||
                ...
                if (rel.relType === "ownedBy") {
                    ...
                    for (let i = 0; i < cardinality; i++) {
                        instance[rel.property].push(key());
                    }
                }
            }
        });
...
export { property, pushKey, constrainedProperty, constrain, min, max, length, desc, mock, hasMany, ownedBy, inverse, model, Model, RelationshipPolicy, RelationshipCardinality, Record, List, Mock$$1 as Mock };
