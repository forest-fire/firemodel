...
var require_get_value = __commonJS((exports, module) => {
  ...
  module.exports = function(target, path3, options) {
    if (!isObject(options)) {
    ...
    const isArray2 = Array.isArray(path3);
    ...
    if (isString && path3 in target) {
      return isValid11(path3, target, options) ? target[path3] : options.default;
    }
    let segs = isArray2 ? path3 : split(path3, splitChar, options);
    let len = segs.length;
    let idx = 0;
    do {
      let prop = segs[idx];
  ...
  function split(path3, splitChar, options) {
    if (typeof options.split === "function") {
      return options.split(path3);
    }
    return path3.split(splitChar);
  }
...
var require_set_value = __commonJS((exports, module) => {
  ...
  function set5(target, path3, value, options) {
    if (!isObject(target)) {
      return target;
    }
    let opts = options || {};
    const isArray2 = Array.isArray(path3);
    if (!isArray2 && typeof path3 !== "string") {
      return target;
    }
    ...
    const keys2 = (isArray2 ? path3 : split(path3, opts)).filter(isValidKey);
  ...
  function result(target, path3, value, merge) {
    if (merge && isPlain(target[path3]) && isPlain(value)) {
      target[path3] = merge({}, target[path3], value);
    } else {
      target[path3] = value;
    }
  }
  function split(path3, options) {
    const id = createKey(path3, options);
    if (set5.memo[id])
      return set5.memo[id];
    ...
    if (options && typeof options.split === "function") {
      keys2 = options.split(path3);
    } else {
      keys2 = path3.split(char);
    }
...
var require_lodash = __commonJS((exports, module) => {
  ...
  function baseGet(object, path3) {
    ...
    var index10 = 0, length2 = path3.length;
    while (object != null && index10 < length2) {
      object = object[toKey(path3[index10++])];
    }
  ...
  function get4(object, path3, defaultValue2) {
...
var require_src = __commonJS((exports) => {
  __export(exports, {
    AuditLog: () => AuditLog2,
    DexieDb: () => DexieDb,
    DexieList: () => DexieList2,
    DexieRecord: () => DexieRecord2,
    FireModel: () => FireModel2,
    FmEvents: () => FmEvents,
    ...
    VeuxWrapper: () => VeuxWrapper,
    Watch: () => Watch,
    belongsTo: () => belongsTo,
    constrain: () => constrain,
    constrainedProperty: () => constrainedProperty,
    createCompositeKey: () => createCompositeKey2,
    ...
    length: () => length,
    listRegisteredModels: () => listRegisteredModels,
    max: () => max3,
    min: () => min3,
    mock: () => mock,
    model: () => model,
    modelConstructorLookup: () => modelConstructorLookup,
    modelNameLookup: () => modelNameLookup,
    modelRegister: () => modelRegister,
    modelRegistryLookup: () => modelRegistryLookup,
    ownedBy: () => ownedBy,
    pathJoin: () => pathJoin2,
    property: () => property,
    pushKey: () => pushKey,
...
function modelRegister(...models) {
  models.forEach((model3) => {
    if (!model3) {
      throw new FireModelError2(`An attempt was made to register a Model subclass but the passed in constructor was undefined!${models.length > 0 ? ` [ ${models.length} models being registed during this call ]` : ""}`, "firemodel/not-allowed");
    }
...
__decorate([
  property
], Model60.prototype, "id", 2);
__decorate([
  property,
  mock("dateRecentMiliseconds"),
  index6
], Model60.prototype, "lastUpdated", 2);
__decorate([
  property,
  mock("datePastMiliseconds"),
  index6
], Model60.prototype, "createdAt", 2);
Model60 = __decorate([
  model()
], Model60);

// src/models/AuditLog.ts
let AuditLog2 = class extends Model60 {
};
__decorate([
  property,
  index6
], AuditLog2.prototype, "modelName", 2);
__decorate([
  property,
  index6
], AuditLog2.prototype, "modelId", 2);
__decorate([
  property
], AuditLog2.prototype, "changes", 2);
__decorate([
  property
], AuditLog2.prototype, "action", 2);
AuditLog2 = __decorate([
...
function doubleDotOnlyToStart(path3) {
  if (path3.slice(2).includes("..")) {
    throw new PathJoinError("not-allowed", `The path "${path3}" is not allowed because it  has ".." in it. This notation is fine at the beginning of a path but no where else.`);
  }
  return path3;
}
function removeSingleDotExceptToStart(path3) {
  let parts = path3.split("/");
...
const _11 = __toModule(require_src());
...
async function processHasMany3(rec, property2) {
  ...
  for (const key2 of Object.keys(fks)) {
    const fk5 = fks[key2];
    if (fk5 !== true) {
      const fkRecord = await _11.Record.add(meta2.fkConstructor(), fk5, {
...
async function processBelongsTo(rec, property2) {
  const fk5 = rec.get(property2);
  const meta2 = getModelMeta(rec).property(property2);
  if (fk5 && typeof fk5 === "object") {
    const fkRecord = _11.Record.add(meta2.fkConstructor(), fk5, {
      setDeepRelationships: true
    });
  }
}
...
var FmEvents;
(function(FmEvents7) {
  FmEvents7["RECORD_ADDED_LOCALLY"] = "@firemodel/RECORD_ADDED_LOCALLY";
  FmEvents7["RECORD_ADDED_CONFIRMATION"] = "@firemodel/RECORD_ADDED_CONFIRMATION";
  FmEvents7["RECORD_ADDED_ROLLBACK"] = "@firemodel/RECORD_ADDED_ROLLBACK";
  FmEvents7["RECORD_ADDED"] = "@firemodel/RECORD_ADDED";
  FmEvents7["RECORD_CHANGED_LOCALLY"] = "@firemodel/RECORD_CHANGED_LOCALLY";
  FmEvents7["RECORD_CHANGED_CONFIRMATION"] = "@firemodel/RECORD_CHANGED_CONFIRMATION";
  FmEvents7["RECORD_CHANGED_ROLLBACK"] = "@firemodel/RECORD_CHANGED_ROLLBACK";
  FmEvents7["RECORD_CHANGED"] = "@firemodel/RECORD_CHANGED";
  FmEvents7["RECORD_MOVED"] = "@firemodel/RECORD_MOVED";
  FmEvents7["RECORD_REMOVED_LOCALLY"] = "@firemodel/RECORD_REMOVED_LOCALLY";
  FmEvents7["RECORD_REMOVED_CONFIRMATION"] = "@firemodel/RECORD_REMOVED_CONFIRMATION";
  FmEvents7["RECORD_REMOVED_ROLLBACK"] = "@firemodel/RECORD_REMOVED_LOCALLY";
  FmEvents7["RECORD_REMOVED"] = "@firemodel/RECORD_REMOVED";
  FmEvents7["PERMISSION_DENIED"] = "@firemodel/PERMISSION_DENIED";
  FmEvents7["RECORD_LOCAL_ROLLBACK"] = "@firemodel/RECORD_LOCAL_ROLLBACK";
  FmEvents7["SINCE_UPDATED"] = "@firemodel/SINCE_UPDATED";
  FmEvents7["WATCHER_STARTING"] = "@firemodel/WATCHER_STARTING";
  FmEvents7["WATCHER_STARTED"] = "@firemodel/WATCHER_STARTED";
  FmEvents7["WATCHER_SYNC"] = "@firemodel/WATCHER_SYNC";
  FmEvents7["WATCHER_FAILED"] = "@firemodel/WATCHER_FAILED";
  FmEvents7["WATCHER_STOPPED"] = "@firemodel/WATCHER_STOPPED";
  FmEvents7["WATCHER_STOPPED_ALL"] = "@firemodel/WATCHER_STOPPED_ALL";
  FmEvents7["RELATIONSHIP_REMOVED_LOCALLY"] = "@firemodel/RELATIONSHIP_REMOVED_LOCALLY";
  FmEvents7["RELATIONSHIP_REMOVED_CONFIRMATION"] = "@firemodel/RELATIONSHIP_REMOVED_CONFIRMATION";
  FmEvents7["RELATIONSHIP_REMOVED_ROLLBACK"] = "@firemodel/RELATIONSHIP_REMOVED_ROLLBACK";
  FmEvents7["RELATIONSHIP_ADDED_LOCALLY"] = "@firemodel/RELATIONSHIP_ADDED_LOCALLY";
  FmEvents7["RELATIONSHIP_ADDED_CONFIRMATION"] = "@firemodel/RELATIONSHIP_ADDED_CONFIRMATION";
  FmEvents7["RELATIONSHIP_ADDED_ROLLBACK"] = "@firemodel/RELATIONSHIP_ADDED_ROLLBACK";
  FmEvents7["RELATIONSHIP_SET_LOCALLY"] = "@firemodel/RELATIONSHIP_SET_LOCALLY";
  FmEvents7["RELATIONSHIP_SET_CONFIRMATION"] = "@firemodel/RELATIONSHIP_SET_CONFIRMATION";
  FmEvents7["RELATIONSHIP_SET_ROLLBACK"] = "@firemodel/RELATIONSHIP_ADDED_ROLLBACK";
  FmEvents7["RELATIONSHIP_DUPLICATE_ADD"] = "@firemodel/RELATIONSHIP_DUPLICATE_ADD";
  FmEvents7["APP_CONNECTED"] = "@firemodel/APP_CONNECTED";
  FmEvents7["APP_DISCONNECTED"] = "@firemodel/APP_DISCONNECTED";
  FmEvents7["UNEXPECTED_ERROR"] = "@firemodel/UNEXPECTED_ERROR";
})(FmEvents || (FmEvents = {}));
...
async function writeAudit(record, action, changes, options = {}) {
  ...
  await Record2.add(index.AuditLog, {
...
class FkDoesNotExist extends FireModelError2 {
  constructor(pk5, property2, fkId) {
    const fkConstructor = pk5.META.relationship("property").fkConstructor();
    const fkModel = new fkConstructor();
    const message = `Attempt add a FK on of "${pk5.constructor.name}::${fkId}" failed because the model "${fkModel.constructor.name}::${fkId}" doesn't exist!`;
...
class DuplicateRelationship extends FireModelError2 {
  constructor(pk5, property2, fkId) {
    const fkConstructor = pk5.META.relationship("property").fkConstructor();
    const fkModel = new fkConstructor();
    const message = `Attempt add a FK on of "${pk5.constructor.name}::${fkId}" failed because the model "${fkModel.constructor.name}::${fkId}" already had that relationship defined! You can either set the "duplicationIsError" to "false" (the default) or treat this as an error and fix`;
...
// src/List.ts
const universal_fire4 = __toModule(require("universal-fire"));
...
class List extends FireModel2 {
  ...
  static async fromQuery(model3, query, options = {}) {
    ...
    const path3 = options && options.offsets ? List.dbPath(model3, options.offsets) : List.dbPath(model3);
    query.setPath(path3);
    list._query = query;
  ...
  static async all(model3, options = {}) {
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild("lastUpdated");
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  static async first(model3, howMany, options = {}) {
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild("createdAt").limitToLast(howMany);
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  static async recent(model3, howMany, offset = 0, options = {}) {
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild("lastUpdated").limitToFirst(howMany);
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  static async since(model3, since, options = {}) {
    ...
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild("lastUpdated").startAt(since);
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  static async inactive(model3, howMany, options = {}) {
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild("lastUpdated").limitToLast(howMany);
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  static async last(model3, howMany, options = {}) {
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild("createdAt").limitToFirst(howMany);
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  ...
  static async where(model3, property2, value, options = {}) {
    ...
    const query = universal_fire4.SerializedQuery.create(this.defaultDb).orderByChild(property2).where(operation, val);
    const list = await List.fromQuery(model3, query, options);
    return list;
  }
  static async ids(model3, ...fks) {
    ...
    const results = [];
    fks.forEach((fk5) => {
      promises.push(Record2.get(model3, fk5).then((p) => results.push(p.data)));
    });
...
const _20 = __toModule(require_src());
class WatchBase {
  constructor() {
...
The underlying error was: ${e.message}`, "watcher/not-allowed");
    ...
    try {
      if (this._eventType === "value") {
        ...
        if (options.largePayload) {
          ...
          await dispatch({
            type: _20.FmEvents.WATCHER_SYNC,
            kind: "watcher",
      ...
      (this._dispatcher || _20.FireModel.dispatch)({
        type: _20.FmEvents.WATCHER_FAILED,
    ...
    try {
      ...
      (this._dispatcher || _20.FireModel.dispatch)({
        type: _20.FmEvents.WATCHER_STARTING,
        ...watcherItem
      });
      await waitForInitialization(watcherItem);
      await (this._dispatcher || _20.FireModel.dispatch)({
        type: _20.FmEvents.WATCHER_STARTED,
        ...watcherItem
      });
      return watcherItem;
    } catch (e) {
  ...
  getCoreDispatch() {
    const coreDispatch = this._dispatcher || _20.FireModel.dispatch;
  ...
  get db() {
    if (!this._db) {
      if (_20.FireModel.defaultDb) {
        this._db = _20.FireModel.defaultDb;
      }
    }
    return this._db;
  }
...
const universal_fire16 = __toModule(require("universal-fire"));
const _21 = __toModule(require_src());
class WatchList2 extends WatchBase {
  ...
  ids(...ids) {
    ...
    for (const id of ids) {
      this._underlyingRecordWatchers.push(this._options.offsets ? _21.Watch.record(this._modelConstructor, {
        ...typeof id === "string" ? {id} : id,
        ...this._options.offsets
      }) : _21.Watch.record(this._modelConstructor, id));
    }
  ...
  where(property2, value) {
    ...
    this._query = universal_fire16.SerializedQuery.create(this.db, this._query.path).orderByChild(property2).where(operation, val);
    return this;
  }
  setPathDependantProperties() {
    if (this._dynamicProperties.length === 0 || Object.keys(this._offsets).length > 0) {
      ...
      this._query = universal_fire16.SerializedQuery.create(this.db, lst.dbPath);
...
const _22 = __toModule(require_src());
const universal_fire17 = __toModule(require("universal-fire"));
class WatchRecord2 extends WatchBase {
  static record(modelConstructor, pk5, options = {}) {
    if (!pk5) {
    ...
    const r = _22.Record.createWith(modelConstructor, pk5, options.db ? {db: options.db} : {});
    o._query = universal_fire17.SerializedQuery.create(options.db || FireModel2.defaultDb, `${r.dbPath}`);
...
class Watch {
  ...
  static record(modelConstructor, pk5, options = {}) {
    return WatchRecord2.record(modelConstructor, pk5, options);
  }
...
const _14 = __toModule(require_src());
function createCompositeKeyRefFromRecord(rec) {
  const cKey = _14.createCompositeKey(rec);
...
const _16 = __toModule(require_src());
async function relationshipOperation2(rec, operation, property2, fkRefs, paths, options = {}) {
  const fks = fkRefs.map((fk5) => {
    return typeof fk5 === "object" ? createCompositeRef(fk5) : fk5;
  });
  const dispatchEvents = {
    set: [
      _16.FmEvents.RELATIONSHIP_SET_LOCALLY,
      _16.FmEvents.RELATIONSHIP_SET_CONFIRMATION,
      _16.FmEvents.RELATIONSHIP_SET_ROLLBACK
    ],
    clear: [
      _16.FmEvents.RELATIONSHIP_REMOVED_LOCALLY,
      _16.FmEvents.RELATIONSHIP_REMOVED_CONFIRMATION,
      _16.FmEvents.RELATIONSHIP_REMOVED_ROLLBACK
    ],
    add: [
      _16.FmEvents.RELATIONSHIP_ADDED_LOCALLY,
      _16.FmEvents.RELATIONSHIP_ADDED_CONFIRMATION,
      _16.FmEvents.RELATIONSHIP_ADDED_ROLLBACK
    ],
    remove: [
      _16.FmEvents.RELATIONSHIP_REMOVED_LOCALLY,
      _16.FmEvents.RELATIONSHIP_REMOVED_CONFIRMATION,
...
async function localRelnOp(rec, event, type) {
  try {
    event.fks.map((fk5) => {
      locallyUpdateFkOnRecord(rec, fk5, {...event, type});
    });
...
const _5 = __toModule(require_src());
...
${JSON.stringify(payload, null, 2)}`);
      ...
      if (!payload.id) {
        const path3 = _5.List.dbPath(model3, payload);
        payload.id = await r.db.getPushKey(path3);
      }
  ...
  static getCompositeKeyFromPath(model3, path3) {
    if (!path3) {
      return {};
    }
    const r = Record2.create(model3);
    const pathParts = dotNotation(path3).split(".");
    const compositeKey = {};
  ...
  get compositeKey() {
    return _5.createCompositeKey(this);
  }
  get compositeKeyRef() {
...
The META for relationships on the model are: ${JSON.stringify(meta2.relationships, null, 2)}`, `firemodel/unknown`);
  ...
  async _localCrudOperation(crudAction, priorValue, options = {}) {
    ...
    try {
      ...
      switch (crudAction) {
        ...
        case "add":
          try {
            await this.db.set(path3, this.data);
          } catch (e) {
            throw new FireModelProxyError(e, `Problem setting the "${path3}" database path. Data passed in was of type ${typeof this.data}. Error message encountered was: ${e.message}`, `firemodel/${e.code = "permission-denied"}`);
          }
          break;
        case "update":
  ...
  _injectDynamicPathProperties(path3, forProp = "dbOffset") {
    this.dynamicPathComponents.forEach((prop) => {
      ...
      path3 = path3.replace(`:${prop}`, String(this.get(prop)));
    });
    return path3;
  }
  async _getFromDB(id) {
...
const _4 = __toModule(require_src());
async function processHasMany2(record, rel, config, db) {
  const fkMockMeta = (await _4.Mock(rel.fkConstructor(), db).generate(1)).pop();
...
// src/Mock/fakeIt.ts
const _ = __toModule(require_src());
const sequence = {};
...
const _2 = __toModule(require_src());
const firemock3 = __toModule(require("firemock"));
...
// src/Mock/api.ts
const firemock = __toModule(require("firemock"));
...
function createCompositeKey2(rec) {
...
class DexieRecord2 {
  ...
  async get(pk5) {
    return this.table.get(pk5).catch((e) => {
      throw new DexieError2(`DexieRecord: problem getting record ${JSON.stringify(pk5)} of model ${capitalize(this.meta.modelName)}: ${e.message}`, `dexie/${e.code || e.name || "get"}`);
    });
  }
  async add(record) {
    ...
    const pk5 = await this.table.add(record).catch((e) => {
  ...
  async update(pk5, updateHash) {
    const now = new Date().getTime();
    updateHash.lastUpdated = now;
    const result = await this.table.update(pk5, updateHash).catch((e) => {
      throw new DexieError2(`DexieRecord: Problem updating ${capitalize(this.meta.modelName)}.${typeof pk5 === "string" ? pk5 : pk5.id}: ${e.message}`, `dexie/${e.code || e.name || "update"}`);
    });
    if (result === 0) {
      throw new DexieError2(`The primary key passed in to record.update(${JSON.stringify(pk5)}) was NOT found in the IndexedDB!`, "dexie/record-not-found");
    }
    if (result > 1) {
      throw new DexieError2(`While calling record.update(${JSON.stringify(pk5)}) MORE than one record was updated!`, "dexie/unexpected-error");
    }
  }
  async remove(id) {
...
const _7 = __toModule(require_src());
class DexieDb {
  ...
  static modelConversion(...modelConstructors) {
    ...
    return modelConstructors.reduce((agg, curr) => {
      const dexieModel = [];
      const r = _7.Record.createWith(curr, new curr());
  ...
  modelIsManagedByDexie(model3) {
    const r = _7.Record.create(model3);
