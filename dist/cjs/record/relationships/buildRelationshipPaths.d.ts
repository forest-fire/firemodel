 ...
 */
export declare function buildRelationshipPaths<T>(rec: Record<T>, property: Extract<keyof T, string>, fkRef: IFkReference<T>, options?: IFmBuildRelationshipOptions): IFmPathValuePair[];
