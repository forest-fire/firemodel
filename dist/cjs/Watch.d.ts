...
export declare type IWatchListQueries =
  | "all"
  | "first"
  | "last"
  | "since"
...
export declare class Watch {
  ...
  ): Pick<Watch, "start" | "dispatch">;
  static list<T extends Model>(
    modelConstructor: new () => T,
    options?: IModelOptions
  ): Pick<Watch, IWatchListQueries>;
   ...
   */
  where<T extends Model, K extends keyof T>(
    property: K,
