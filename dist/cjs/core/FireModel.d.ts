import { IAbstractedDatabase, IAdminConfig, IClientConfig } from "universal-fire";
import { IDictionary } from "common-types";
import { IFmChangedProperties, IFmModelMeta, IFmModelPropertyMeta, IFmModelRelationshipMeta, IReduxDispatch, IModel } from "../@types/index";
import type { Record } from "./";
export declare class FireModel<T extends IModel> {
    ...
    get dispatch(): IReduxDispatch<import("../@types").IReduxAction, any>;
  ...
  ```
    ...
    static register<T extends IModel = IModel>(model: new () => T): void;
