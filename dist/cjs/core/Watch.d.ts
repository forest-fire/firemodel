import { IModelOptions, IPrimaryKey, IReduxDispatch, IWatcherEventContext } from "../@types/index";
import { IAbstractedDatabase } from "universal-fire";
import { WatchList, WatchRecord } from "./watchers";
 ...
 */
export declare class Watch<T extends IModel = IModel> {
    /**
