import { IFnToModelConstructor, IModel, NamedFakes } from "./index";
...
export interface IFmModelRelationshipMeta<T extends IModel = IModel> extends IFmModelAttributeBase<T> {
    isRelationship: true;
    isProperty: false;
...
export interface IFmModelPropertyMeta<T extends IModel = IModel> extends IFmModelAttributeBase<T> {
...
export declare type MockFunction<T = any> = (context: MockHelper) => T | Promise<T>;
