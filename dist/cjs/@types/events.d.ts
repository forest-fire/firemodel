import { FmEvents, ICompositeKey, IFmLocalRecordEvent, IFmLocalRelationshipEvent, IFmServerOrLocalEvent, IModel, IWatcherEventContext } from "./index";
 ...
 */
export declare type IFmWatchEvent<T extends IModel = IModel> = IFmServerOrLocalEvent<T> & IEventTimeContext<T> & IWatcherEventContext<T>;
/**
 ...
 */
export declare type IFmWatchEventLocalRecord<T extends IModel = IModel> = IFmLocalRecordEvent<T> & IEventTimeContext<T> & IWatcherEventContext<T>;
/**
 ...
 */
export declare type IFmWatchEventLocalRelationship<T extends IModel = IModel> = IFmLocalRelationshipEvent<T> & IEventTimeContext<T> & IWatcherEventContext<T>;
