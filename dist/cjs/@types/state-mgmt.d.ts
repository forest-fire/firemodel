import { FmEvents, IFmPathValuePair, IFmRecordMeta, IFmRelationshipOperation, IModel, IWatchEventClassification, IWatcherSource } from "./index";
 ...
 */
export interface IFmLocalRelationshipEvent<F extends IModel = IModel, T extends IModel = IModel> extends IFmLocalEventBase<F> {
    kind: "relationship";
 ...
 */
export interface IFmLocalRecordEvent<T extends IModel = IModel> extends IFmLocalEventBase<T> {
    kind: "record";
...
export interface IWatcherEventContextBase<T extends IModel = IModel> extends IFmRecordMeta<T> {
    watcherId: string;
 ...
 */
export interface IWatcherEventContextListofRecords<T extends IModel = IModel> extends IWatcherEventContextBase<T> {
...
export interface IWatcherEventContextList<T extends IModel = IModel> extends IWatcherEventContextBase<T> {
    watcherSource: "list";
    /**
...
export interface IWatcherEventContextRecord<T extends IModel = IModel> extends IWatcherEventContextBase<T> {
