...
export declare function min(value: number): (target: import("../model").Model, key: string) => void;
export declare type MockFunction = (context: import("firemock").MockHelper) => any;
export declare function mock(value: string | MockFunction): (target: import("../model").Model, key: string) => void;
export declare function max(value: number): (target: import("../model").Model, key: string) => void;
export declare function length(value: number): (target: import("../model").Model, key: string) => void;
