...
export declare class List<T extends BaseSchema> {
  private _model;
  private _data;
  static create<T extends BaseSchema>(
    schema: new () => T,
  ...
  static first<T extends BaseSchema>(
    schema: new () => T,
    howMany: number,
    options?: IModelOptions
  ): Promise<List<T>>;
  static recent<T extends BaseSchema>(
    schema: new () => T,
    howMany: number,
    options?: IModelOptions
  ): Promise<List<T>>;
  static inactive<T extends BaseSchema>(
    schema: new () => T,
    howMany: number,
    options?: IModelOptions
  ): Promise<List<T>>;
  static last<T extends BaseSchema>(
    schema: new () => T,
    howMany: number,
    options?: IModelOptions
  ): Promise<List<T>>;
  static where<T extends BaseSchema, K extends keyof T>(
    schema: new () => T,
    property: K,
